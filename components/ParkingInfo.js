...
export default class ParkingInfo extends React.Component {
  render() {
    const { selectedParking, makeRoute, myLocation, currentlyOnParking } = this.props;
    return (
      <View style={styles.tabBarInfoContainer}>
        {currentlyOnParking && (
          <View style={{ padding: 15, backgroundColor: 'green', width: '100%' }}>
            <Text style={{ color: 'white' }}>Currently parked</Text>
          </View>
        )}
